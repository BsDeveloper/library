...

		{
...

			{
				...
				$weleh = array (
								...
								'video_category_title' 			=> $this->input->post('video_category_title'),

								'video_category_slug' 			=> url_title($this->input->post('video_category_title'), 'dash', TRUE)
...

	{
...

		{
...

			{
				...
				$weleh = array ('video_category_title' 			=> $this->input->post('video_category_title'),
