...

	{
...

		{
...

			{
				...
				// 	$file_dokumen	= $wew->video_picture;
				...
				$weleh = array ('video_title' 		=> $this->input->post('video_title'),
...

	{
...

		{
...

			{
				...
				// $config['upload_path'] 		= './uploads/video/'.$wew->video_slug;
				...
				$weleh = array (
								...
								'video_list_title' 		=> $this->input->post('video_list_title'),

								'video_list_slug' 		=> url_title($this->input->post('video_list_title'), 'dash', TRUE),

								'video_list_link' 		=> $this->input->post('video_list_link'),

								// 'video_list_type' 		=> $this->input->post('video_list_type'),

								// 'video_list_list' 	=> $file_dokumen,
...

	{
...

		{
...

			{
				...
				// $config['upload_path'] 		= './uploads/video/'.$video->video_slug;
				...
				// 	$file_dokumen	= $wew->video_list_list;
				...
				$this->model_utama->update_data($this->input->post('video_list_id'),'video_list_id','video_list',$weleh);
