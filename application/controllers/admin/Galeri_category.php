...

		{
...

			{
				...
				$weleh = array (
								...
								'galeri_category_title' 			=> $this->input->post('galeri_category_title'),

								'galeri_category_slug' 			=> url_title($this->input->post('galeri_category_title'), 'dash', TRUE)
...

	{
...

		{
...

			{
				...
				$weleh = array ('galeri_category_title' 			=> $this->input->post('galeri_category_title'),
