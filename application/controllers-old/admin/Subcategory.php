...
class subcategory extends MY_Controller {
	...
	function add()
	{
		if($this->session->userdata('login_admin') == true)
		{
			...
			$data['form_action'] 	= site_url('index.php/admin/subcategory/add_process');
		...
		if($this->session->userdata('login_admin') == true)
		{
			...
			if ($this->form_validation->run() == TRUE)
			{
				...
				$weleh = array (
								...
								'subcategory_slug' 	=> url_title($this->input->post('subcategory_title'), 'dash', TRUE),
	...
	function update($kode)
	{
		if($this->session->userdata('login_admin') == true)
		{
			...
			$data['category_list']	= $this->model_utama->get_order('create_date','desc','category');
			$data['form_action'] 	= site_url('index.php/admin/subcategory/update_process');
	...
	function update_process()
	{
		if($this->session->userdata('login_admin') == true)
		{
			...
			if ($this->form_validation->run() == TRUE)
			{
				...
				$weleh = array ('subcategory_title' 	=> $this->input->post('subcategory_title'),
								'subcategory_slug' 	=> url_title($this->input->post('subcategory_title'), 'dash', TRUE),
								'category_id' 		=> $this->input->post('category_id')
								);
