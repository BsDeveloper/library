            ...
            <div class="col-sm-12">
                ...
                <script>
                    init.push(function () {
                        ...
                        $('#jq-datatables-example_wrapper .table-caption').text('Daftar testimonial');
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo site_url('admin/testimonial/add') ?>"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>
                        <br><br>
                        <?php if($testimonial_list->num_rows() > 0) : $i=1;?>
                        <div class="table-primary" id="tooltips-demo">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                                ...
                                <tbody>
                                <?php foreach($testimonial_list->result() as $row) :?>
                                    <tr class="odd gradeX">
                                        <td><?=$i++?></td>
                                        <td>
                                            <h4><u><a href="<?php echo base_url()?>uploads/testimonial/<?php echo $row->testimonial_picture?>"><?php echo ucwords($row->testimonial_title)?></a></u></h4>
                                        ...
                                        <td class="center">
                                            <a href="<?php echo site_url('admin/testimonial/hide/'.$row->testimonial_id); ?>" onclick="return confirm('Anda yakin akan mengubah data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk <?php echo isset($row->testimonial_hide) && $row->testimonial_hide == 'yes' ? 'tampilkan' : 'sembunyikan'; ?> data" class="btn btn-sm btn-labeled <?php echo isset($row->testimonial_hide) && $row->testimonial_hide == 'yes' ? 'btn-danger' : 'btn-success'; ?>"><span class="btn-label icon fa <?php echo isset($row->testimonial_hide) && $row->testimonial_hide == 'yes' ? 'fa-minus-circle' : 'fa-check'; ?>"></span> <?php echo isset($row->testimonial_hide) && $row->testimonial_hide == 'yes' ? 'Disembunyikan' : 'Ditampilkan'; ?></button></a>
                                        </td>
                                        <td class="center">
                                            <a href="<?php echo site_url('admin/testimonial/update/'.$row->testimonial_id); ?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-warning"><span class="btn-label icon fa fa-pencil"></span></button></a>&nbsp;&nbsp;                                            
                                            <a href="<?php echo site_url('admin/testimonial/delete/'.$row->testimonial_id); ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk hapus data" class="btn btn-sm  btn-danger"><span class="btn-label icon fa fa-times"></span></button></a>
