<div id="content-wrapper">
        ...
        <div class="page-header">
            <h1><span class="text-light-gray"><a href="<?php echo base_url()?>admin/kursus"><?php echo ucwords('kursus') ?></a> / </span><?php echo ucwords($heading)?></h1>
        </div> <!-- / .page-header -->
...
-->
        ...
        <form action="<?php echo $form_action?>" method="post" enctype="multipart/form-data" class="panel form-horizontal form-bordered">
                    <div class="panel-heading">
                        <span class="panel-title"><?php echo set_value('kursus_title', isset($default['kursus_title']) ? ucwords($default['kursus_title']) : ucwords($heading)); ?></span>
                    </div>
                    <div class="panel-body no-padding-hr">
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('kursus_title') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                <label class="col-sm-2 control-label">Nama kursus</label>
                                <div class="col-sm-8">
                                    <input type="text" required name="kursus_title" class="form-control" placeholder="Nama" value="<?php echo set_value('kursus_title', isset($default['kursus_title']) ? $default['kursus_title'] : ''); ?>">
                    ...
                    <div class="panel-footer text-right">
                        ...
                        <!--<a href="<?php echo base_url()?>kursus"><button class="btn btn-danger" type="button">Back</button></a>-->
                    </div>
                </form>
