...
<script type="text/javascript">
	$(document).ready(function (e) {
		...
		$("#uploadimage").on('submit',(function(e) {
			...
			$('#loading').show();
			$.ajax({
				url: baseurl+"admin/level/upload_picture_process/<?php echo $table; ?>", // Url to which the request is send
...
<form id="uploadimage" action="" method="post" enctype="multipart/form-data">
	...
	<div id="selectImage">
		...
		<input type="text" value="<?php echo $kode; ?>" name="<?php echo $table; ?>_id" id="<?php echo $table; ?>_id">
