                    ...
                    <div class="panel-body no-padding-hr">
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('banner_title') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" required name="banner_title" class="form-control" placeholder="Nama" value="<?php echo set_value('banner_title', isset($default['banner_title']) ? $default['banner_title'] : ''); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label class="radio-inline">
                                        ...
                                        <input required type="radio" name="banner_type" id="inlineCheckbox1" value="in" class="px" <?php echo set_radio('banner_type', 'in', isset($default['banner_type']) && $default['banner_type'] == 'in' ? TRUE : FALSE); ?>> <span class="lbl">Tidak</span>

                                    </label>

                                    <label class="radio-inline">

                                        <input required type="radio" name="banner_type" id="inlineCheckbox2" value="out" class="px" <?php echo set_radio('banner_type', 'out', isset($default['banner_type']) && $default['banner_type'] == 'out' ? TRUE : FALSE); ?>> <span class="lbl">Ya</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label class="radio-inline">
                                        ...
                                        <input required type="radio" name="banner_hide" id="inlineCheckbox1" value="no" class="px" <?php echo set_radio('banner_hide', 'no', isset($default['banner_hide']) && $default['banner_hide'] == 'no' ? TRUE : FALSE); ?>> <span class="lbl">Tidak</span>

                                    </label>

                                    <label class="radio-inline">

                                        <input required type="radio" name="banner_hide" id="inlineCheckbox2" value="yes" class="px" <?php echo set_radio('banner_hide', 'yes', isset($default['banner_hide']) && $default['banner_hide'] == 'yes' ? TRUE : FALSE); ?>> <span class="lbl">Ya</span>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img width="100%" src="<?php echo base_url()?>uploads/banner/<?php echo set_value('banner_picture', isset($default['banner_picture']) ? $default['banner_picture'] : '3.jpg'); ?>">
                            </div> <!-- / .modal-body -->
