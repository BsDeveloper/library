                    ...
                    <div class="panel-body no-padding-hr">
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('ticker_title') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" required name="ticker_title" class="form-control" placeholder="Nama" value="<?php echo set_value('ticker_title', isset($default['ticker_title']) ? $default['ticker_title'] : ''); ?>">
                        ...
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('ticker_description') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="ticker_description" class="form-control" placeholder="subtitle" value="<?php echo set_value('ticker_description', isset($default['ticker_description']) ? $default['ticker_description'] : ''); ?>">
