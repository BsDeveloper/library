            ...
            <div class="col-sm-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo site_url('admin/video/add') ?>"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>

                        <br><br>

                        <?php if($video_list->num_rows() > 0) : $i=1;?>
                                ...
                                <?php foreach($video_list->result() as $row) :?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <h4><?php echo ucwords($row->video_title)?><br>

                                            <small><?php echo $row->video_link?></small>
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo site_url('admin/video/video_list/'.$row->video_id) ?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-success"><span class="btn-label icon fa fa-plus"></span></button></a>&nbsp;&nbsp;

                                        </td>

                                        <td class="center">

                                            <a href="<?php echo site_url('admin/video/update/'.$row->video_id) ?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-warning"><span class="btn-label icon fa fa-pencil"></span></button></a>&nbsp;&nbsp;

                                            <a href="<?php echo site_url('admin/video/delete/'.$row->video_id) ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk hapus data" class="btn btn-sm  btn-danger"><span class="btn-label icon fa fa-minus-circle"></span></button></a>
