            ...
            <div class="col-sm-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo site_url('admin/berita/add') ?>"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>
                        <br><br>
                        <?php if($berita_list->num_rows() > 0) : $i=1;?>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                                ...
                                <?php foreach($berita_list->result() as $row) :?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a href="<?php echo site_url('admin/berita/update/'.$row->blog_id); ?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-warning"><span class="btn-label icon fa fa-pencil"></span></button></a>&nbsp;&nbsp;
                                            <a href="<?php echo site_url('admin/berita/delete/'.$row->blog_id); ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk hapus data" class="btn btn-sm  btn-danger"><span class="btn-label icon fa fa-minus-circle"></span></button></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>   
                                </tbody>
