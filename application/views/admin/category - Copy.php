...
class category extends MY_Controller {
	...
	function add()
	{
		if($this->session->userdata('login_admin') == true)
		{
			...
			$data['form_action'] 	= site_url('index.php/admin/category/add_process');
			$data['category_list']	= $this->model_utama->get_order('create_date','desc','category');
		...
		if($this->session->userdata('login_admin') == true)
		{
			...
			if ($this->form_validation->run() == TRUE)
			{
				...
				$weleh = array (
								...
								'category_slug' 			=> url_title($this->input->post('category_title'), 'dash', TRUE)
								);
	...
	function update($kode)
	{
		if($this->session->userdata('login_admin') == true)
		{
			...
			$data['form_action'] 	= site_url('index.php/admin/category/update_process');
	...
	function update_process()
	{
		if($this->session->userdata('login_admin') == true)
		{
			...
			if ($this->form_validation->run() == TRUE)
			{
				...
				$weleh = array ('category_title' 			=> $this->input->post('category_title'),
								'category_slug' 			=> url_title($this->input->post('category_title'), 'dash', TRUE),
								);
