<div id="content-wrapper">
        ...
        <div class="page-header">
            <h1><span class="text-light-gray"><a href="<?php echo site_url('admin/abstrak')?>"><?php echo ucwords('abstrak') ?></a> / </span><?php echo ucwords($heading)?></h1>
        </div> <!-- / .page-header -->
...
-->
        ...
        <script>
            init.push(function () {
                $('#styled-finputs-example').pixelFileInput({ placeholder: 'File Only' });
        ...
        <form action="<?php echo $form_action?>" method="post" enctype="multipart/form-data" class="panel form-horizontal form-bordered">
                    ...
                    <div class="panel-body no-padding-hr">
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('blog_title') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" required name="blog_title" class="form-control" placeholder="Judul" value="<?php echo set_value('blog_title', isset($default['blog_title']) ? $default['blog_title'] : ''); ?>">
                        ...
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('blog_tahun') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                <label class="col-sm-2 control-label">Tahun</label>
                                <div class="col-sm-8">
                                    <input type="text" required name="blog_tahun" class="form-control" placeholder="Tahun" value="<?php echo set_value('blog_tahun', isset($default['blog_tahun']) ? $default['blog_tahun'] : ''); ?>">
                                    <?php echo form_error('blog_tahun', '<span class="help-block"><i class="fa fa-warning"></i> ', '</span>'); ?>
                                </div>
                            </div>
                        </div>

                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('blog_nomor') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                <label class="col-sm-2 control-label">Nomor</label>
                                <div class="col-sm-8">
                                    <input type="text" required name="blog_nomor" class="form-control" placeholder="Nomor" value="<?php echo set_value('blog_nomor', isset($default['blog_nomor']) ? $default['blog_nomor'] : ''); ?>">
                                    <?php echo form_error('blog_nomor', '<span class="help-block"><i class="fa fa-warning"></i> ', '</span>'); ?>
                                </div>
                            </div>
                        </div>

                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('blog_perihal') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                <label class="col-sm-2 control-label">Perihal</label>
                                <div class="col-sm-8">
                                    <input type="text" required name="blog_perihal" class="form-control" placeholder="Perihal" value="<?php echo set_value('blog_perihal', isset($default['blog_perihal']) ? $default['blog_perihal'] : ''); ?>">
                                    <?php echo form_error('blog_perihal', '<span class="help-block"><i class="fa fa-warning"></i> ', '</span>'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('userfile') != '') { echo 'has-error'; } ?>">
                             <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <a href="<?php echo base_url()?>uploads/blog/<?php echo isset($default['blog_picture']) ? $default['blog_picture'] : ''; ?>" class="btn btn-labeled btn-primary <?php if((isset($default['blog_picture']) ? $default['blog_picture'] : '') == '' ) : echo 'disabled'; endif; ?>"><span class="btn-label icon fa fa-download"></span> DOwnload</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-footer text-right">
                        ...
                        <a href="<?php echo site_url('abstrak')?>"><button class="btn btn-danger" type="button">Back</button></a>
                    </div>
                </form>
