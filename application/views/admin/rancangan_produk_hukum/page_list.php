            ...
            <div class="col-sm-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo site_url('admin/rancangan_produk_hukum/add') ?>"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>
                        <br><br>
                        <?php if($rancangan_produk_hukum_list->num_rows() > 0) : $i=1;?>
                        <div class="table-primary" id="tooltips-demo">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                                ...
                                <tbody>
                                <?php foreach($rancangan_produk_hukum_list->result() as $row) :?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $i++?></td>
                                        <td>
                                        ...
                                        <td>
                                            <h5><?php echo ucwords($row->rancangan_produk_hukum_nomor)?></h5>
                                        </td>
                                        <td>
                                            <h5><?php echo ucwords($row->rancangan_produk_hukum_title)?></h5>
                                        </td>
                                        <!-- <td class="center">
                                            <a href="<?php echo base_url() ?>uploads/rancangan_produk_hukum/<?php echo $row->rancangan_produk_hukum_file; ?>">
                                        ...
                                        <td class="center" >
                                            <a href="<?php echo site_url('admin/rancangan_produk_hukum/update/'.$row->rancangan_produk_hukum_id); ?>">
                                        ...
                                        <td class="center" >
                                            ...
                                            <a href="<?php echo site_url('admin/rancangan_produk_hukum/delete/'.$row->rancangan_produk_hukum_id); ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" >
