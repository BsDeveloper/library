<div id="content-wrapper">
        ...
        <div class="page-header">
            <h1><span class="text-light-gray"><a href="<?php echo base_url()?>admin/blog"><?php echo ucwords('blog') ?></a> / </span><?php echo ucwords($heading)?></h1>
        </div> <!-- / .page-header -->
...
-->
        ...
        <form action="<?php echo $form_action?>" method="post" enctype="multipart/form-data" class="panel form-horizontal form-bordered">
                    ...
                    <div class="panel-body no-padding-hr">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group date" id="bs-datepicker-component">
                                        <input  type="text" name="blog_date" class="form-control" placeholder="tanggal" value="<?php echo set_value('blog_date', isset($default['blog_date']) ? $default['blog_date'] : ''); ?>"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                        ...
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('blog_type') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                <label class="col-sm-2 control-label"><strong>Tipe Link *</strong></label>
                                <div class="col-sm-8">
                                    <label class="radio-inline">
                                        <input type="radio" name="blog_type" id="inlineCheckbox1" value="in" class="px" <?php echo set_radio('blog_type', 'in', isset($default['blog_type']) && $default['blog_type'] == 'in' ? TRUE : FALSE); ?>> <span class="lbl">Tautan Halaman</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="blog_type" id="inlineCheckbox2" value="out" class="px" <?php echo set_radio('blog_type', 'out', isset($default['blog_type']) && $default['blog_type'] == 'out' ? TRUE : FALSE); ?>> <span class="lbl">Tautan Keluar</span>
                                    </label>
                                    <?php echo form_error('blog_type', '<span class="help-block"><i class="fa fa-warning"></i> ', '</span>'); ?>
                                </div>
                            </div>
                        </div>
