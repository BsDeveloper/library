            ...
            <div class="col-sm-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo base_url() ?>admin/blog/add"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>
                        <br><br>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                                ...
                                <?php foreach($blog_list->result() as $row) :?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url() ?>admin/blog/update/<?php echo $row->blog_id?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-warning"><span class="btn-label icon fa fa-pencil"></span></button></a>&nbsp;&nbsp;
                                            <a href="<?php echo base_url() ?>admin/blog/delete/<?php echo $row->blog_id?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk hapus data" class="btn btn-sm  btn-danger"><span class="btn-label icon fa fa-minus-circle"></span></button></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>   
                                </tbody>
