<div id="content-wrapper">
        ...
        <div class="page-header">
            <h1><span class="text-light-gray"><a href="<?php echo base_url()?>admin/slider"><?php echo ucwords('slider') ?></a> / </span><?php echo ucwords($heading)?></h1>
        </div> <!-- / .page-header -->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img width="100%" src="<?php echo base_url()?>uploads/slider/<?php echo set_value('slider_picture', isset($default['slider_picture']) ? $default['slider_picture'] : '3.jpg'); ?>">
                            </div> <!-- / .modal-body -->
