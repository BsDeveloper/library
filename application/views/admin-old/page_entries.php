            ...
            <div class="col-sm-12">
                ...
                <script>
                    init.push(function () {
                        ...
                        $('#jq-datatables-example_wrapper .table-caption').text('Daftar entries');
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo base_url() ?>admin/entries/add"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>
                        <br><br>
                        <?php if($entries_list->num_rows() > 0) : $i=1;?>
                        <div class="table-primary" id="tooltips-demo">
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                                ...
                                <tbody>
                                <?php foreach($entries_list->result() as $row) :?>
                                    <tr class="odd gradeX">
                                        <td><?php echo $i++?></td>
                                        <td>
                                            <h4><?php echo ucwords($row->entries_title)?></h4>
                                        </td>
                                        <td class="center">
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url() ?>admin/entries/update/<?php echo $row->entries_id?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-warning"><span class="btn-label icon fa fa-pencil"></span></button></a>&nbsp;&nbsp;
                                            <a href="<?php echo base_url() ?>admin/entries/delete/<?php echo $row->entries_id?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk hapus data" class="btn btn-sm  btn-danger"><span class="btn-label icon fa fa-minus-circle"></span></button></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>   
                                </tbody>
