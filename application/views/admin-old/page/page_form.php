<div id="content-wrapper">
        ...
        <div class="page-header">
            <h1><span class="text-light-gray"><a href="<?php echo base_url()?>admin/page"><?php echo ucwords('page') ?></a> / </span><?php echo ucwords($heading)?></h1>
        </div> <!-- / .page-header -->
                    ...
                    <div class="panel-body no-padding-hr">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <label class="radio-inline">
                                        <input type="radio" name="page_type" id="inlineCheckbox1" value="in" class="px" <?php echo set_radio('page_type', 'in', isset($default['page_type']) && $default['page_type'] == 'in' ? TRUE : FALSE); ?>> <span class="lbl">Tautan Halaman</span>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="page_type" id="inlineCheckbox2" value="out" class="px" <?php echo set_radio('page_type', 'out', isset($default['page_type']) && $default['page_type'] == 'out' ? TRUE : FALSE); ?>> <span class="lbl">Tautan Keluar</span>
                                    </label>
                        ...
                        <div class="form-group no-margin-hr panel-padding-h no-padding-t no-border-t <?php if(form_error('page_link') != '') { echo 'has-error'; } ?>">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <input type="url" name="page_link" class="form-control" placeholder="Link" value="<?php echo set_value('page_link', isset($default['page_link']) ? $default['page_link'] : ''); ?>">
