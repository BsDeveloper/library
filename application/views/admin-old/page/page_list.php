            ...
            <div class="col-sm-12">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo base_url() ?>admin/page/add"><button class="btn btn-labeled btn-success"><span class="btn-label icon fa fa-plus"></span> Add</button></a>
                        <br><br>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                                ...
                                <?php foreach($page_list->result() as $row) :?>
                                    <tr class="odd gradeX">
                                        <td><?=$i++?></td>
                                        <td>
                                            <h4><?php echo ucwords($row->page_title)?></h4>
                                        </td>
                                        <td class="center">
                                        ...
                                        <td class="center">
                                            <a href="<?php echo base_url() ?>admin/page/update/<?php echo $row->page_id?>"><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk ubah data" class="btn btn-sm  btn-warning"><span class="btn-label icon fa fa-pencil"></span></button></a>&nbsp;&nbsp;
                                            <a href="<?php echo base_url() ?>admin/page/delete/<?php echo $row->page_id?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" ><button data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Klik untuk hapus data" class="btn btn-sm  btn-danger"><span class="btn-label icon fa fa-minus-circle"></span></button></a>
                                        </td>
                                    </tr>
                                <?php endforeach;?>   
                                </tbody>
