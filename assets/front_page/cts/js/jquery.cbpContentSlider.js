...
;( function( $, window, undefined ) {
	...
	$.CBPContentSlider.prototype = {
		_init : function( options ) {
			...
			this.$navleft =  this.$el.find('.navleftx');
			this.$navright =  this.$el.find('.navrightx');
			this.totaltabs = this.$el.find('nav > a').length;
		...
		_initEvents : function() {
			...
			//----- added by Fransen (instructor of babastudio.com) start ----------
			this.$navleft.on('click.cbpContentSlider', function( event ) {
			...
			this.$navright.on('click.cbpContentSlider', function( event ) {
			...
			//----- added by Fransen (instructor of babastudio.com) end ----------
